...
server.get('/', (req, res) => {
    res.json({
        'All countries': 'http://localhost:3000/api/country',
        'Single country': 'http://localhost:3000/api/country/:id', 
        'All Films': 'http://localhost:3000/api/film', 
        'Filter Films By Rating':
            "http://localhost:3000/api/film?rating=('G','PG','PG-13','R','NC-17')"
    })
})
...
//single route
server.get('/api/country/:id', (req, res)=> {
